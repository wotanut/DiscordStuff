    ...
    return class extends Plugin {
        ...
        sanitizeUrls(content, regex) {
            ...
            trackers.forEach( url =>
                content = content.replace(url, url.split('?')[0].split('&')[0])
            );
		...
		getSettingsPanel() {
				...
				new Settings.Switch("YouTube", "Remove YouTube tracking URL", this.settings.youtube, (i) => { this.settings.youtube = i; }), // New setting for YouTube
